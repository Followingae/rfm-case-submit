...
export default function LoginPage() {
  ...
  return (
    <div className="w-full h-dvh relative overflow-hidden flex flex-col md:flex-row p-12 gap-3 bg-white dark:bg-zinc-950">
      {/* ── Left: Form panel ── */}
      <div className="md:w-1/2 flex flex-col justify-between p-8 md:p-16 rounded-xl z-10">
        {/* Logo */}
        <img src="/rfm-logo.jpg" alt="RFM Loyalty" className="h-8 w-fit" />
      ...
      <div className="hidden md:block relative md:w-1/2 rounded-xl overflow-hidden bg-zinc-900">
        ...
        <div className="absolute top-12 left-12 z-30">
          <h2 className="text-4xl md:text-6xl font-normal leading-[1.1] tracking-tight text-white">
            Merchant Processing
            <br />
            & Management
          </h2>
