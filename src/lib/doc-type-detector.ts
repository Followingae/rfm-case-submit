...
export const DOC_TYPES: DocTypeKeywords[] = [
  ...
  },
  {
    ...
    label: "Trade License",
    keywords: [
      { text: "trade license", weight: 8 },
      { text: "license number", weight: 4 },
      { text: "kiosk permit", weight: 7 },
      { text: "warehouse permit", weight: 7 },
      { text: "lease agreement", weight: 5 },
      { text: "commercial license", weight: 7 },
      { text: "DED", weight: 3 },
      { text: "JAFZA", weight: 3 },
      { text: "DMCC", weight: 3 },
      { text: "RAKEZ", weight: 3 },
  ...
  },
  {
    ...
    keywords: [
      { text: "tax registration", weight: 8 },
      { text: "federal tax authority", weight: 8 },
      { text: "vat certificate", weight: 8 },
      { text: "TRN", weight: 5 },
      { text: "value added tax", weight: 5 },
      { text: "vat registration", weight: 7 },
      { text: "tax registration number", weight: 7 },
      { text: "vat", weight: 2 },
    ],
  },
  {
  ...
  },
  {
    ...
    keywords: [
      ...
      { text: "cheque", weight: 3 },
      { text: "check number", weight: 3 },
      { text: "payable to", weight: 2 },
      { text: "bank cheque", weight: 4 },
      { text: "receipt", weight: 1 },
    ],
  },
  {
  ...
  },
  {
    ...
    keywords: [
      { text: "account confirmation", weight: 8 },
      { text: "iban confirmation", weight: 8 },
      { text: "welcome letter", weight: 6 },
      { text: "bank confirmation", weight: 6 },
      { text: "iban", weight: 5 },
      { text: "swift", weight: 3 },
      { text: "bic", weight: 3 },
  ...
  },
  {
    ...
    keywords: [
      ...
      { text: "supplier", weight: 3 },
      { text: "tax invoice", weight: 4 },
      { text: "proforma", weight: 3 },
      { text: "purchase order", weight: 2 },
      { text: "bill to", weight: 2 },
      { text: "ship to", weight: 2 },
      { text: "unit price", weight: 2 },
...
export const SLOT_TO_DOCTYPE: Record<string, string[]> = {
  ...
  "freezone-aoa": ["moa"],
  "freezone-share-cert": ["moa"],
  "freezone-incumbency": ["moa"],
  "freezone-bor": ["moa"],
  "org-structure": ["moa"],
  "letter-of-intent": ["moa"],
  "justification-letter": ["moa"],
  "merchant-risk-assessment": ["aml-questionnaire"],
  "supplier-invoice": ["supplier-invoice", "payment-proof"],
  "personal-bank": ["bank-statement"],
  "aml-policy": ["aml-questionnaire"],
  "goaml-screenshot": [],
  // Virtual KYC slots for bulk upload detection
